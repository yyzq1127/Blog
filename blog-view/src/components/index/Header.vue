<template>
  <header ref="header">
    <div class="view">
      ...
      <div class="bg1"
           style="background-image: url('https://cdn.jsdelivr.net/gh/Naccl/blog-resource/img/bg1.jpg');"></div>
      <div class="bg2"
           style="background-image: url('https://cdn.jsdelivr.net/gh/Naccl/blog-resource/img/bg2.jpg');"></div>
      <div class="bg3" style="background-image: url('https://cdn.jsdelivr.net/gh/Naccl/blog-resource/img/bg3.jpg');"
           v-show="loaded"></div>
    </div>
